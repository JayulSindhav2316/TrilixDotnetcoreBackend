...
namespace AuthorizeNetCore
{
	public class CustomerPaymentProfile
	{
		...
		public async Task<CreateCustomerPaymentProfileResponse> CreateAsync(string customerProfileId, string nonce, string referenceId, CustomerContact billTo, bool defaultProfile)
		{
		...
		public async Task<DeleteCustomerPaymentProfileResponse> DeleteAsync(string customerPaymentProfileId, string customerProfileId)
		{
