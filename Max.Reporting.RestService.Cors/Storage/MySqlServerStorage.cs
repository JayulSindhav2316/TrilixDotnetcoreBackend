...
namespace CSharp.Core31.Html5IntegrationDemo
{
    public class MySqlServerStorage : IStorage2,IStorage
    {
        ...
        /// </param>
        public MySqlServerStorage(string connectionString)
        {
        ...
        /// </param>
        public MySqlServerStorage(string connectionString, int commandTimeout)
            : this(connectionString, cmdTimeout: commandTimeout)
        {
        }

        internal MySqlServerStorage(string connectionString, int? cmdTimeout)
        ...
        {
            var type = typeof(MySqlServerStorage);
